...
class ProductModel {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
    ...
    varient: json["varient"] == null
        ? []
        : List<Varient>.from(json["varient"]!.map((x) => Varient.fromJson(x))),
...
class ImageGallery {
  ...
  ImageGallery({this.title, this.url});

  factory ImageGallery.fromJson(Map<String, dynamic> json) =>
      ImageGallery(title: json["title"], url: json["url"]);
...
class Varient {
  ...
  Varient({this.category, this.items});
...
class VarientItem {
  ...
  VarientItem({this.title, this.description});

  factory VarientItem.fromJson(Map<String, dynamic> json) =>
      VarientItem(title: json["title"], description: json["description"]);
